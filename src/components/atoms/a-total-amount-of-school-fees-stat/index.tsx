...
function TotalAmountOfSchoolFeesStat({ totalAmountOfSchoolFees }: { totalAmountOfSchoolFees: number }) {
    return (
        <div className="h-[12rem] w-[12rem] bg-white shadow-md p-4 flex flex-col items-center justify-center rounded-md space-y-4">
            ...
            <span className="font-bold text-[1.5rem]">N {totalAmountOfSchoolFees.toLocaleString('en-US')}</span>
